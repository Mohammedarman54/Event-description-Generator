        ...
        if response.status_code == 200:
            ...
            if json_match:
                try:
                    ...
                    # Extract details in pointwise format
                    ...
                    return {
                        "generated_event_description": [
                            ...
                            f"🌟 **Key Attractions:** {key_attractions}",
                            f"📝 **Event Summary:** {event_description}"
                        ],
                        "social_media_post": [
                            f"📢 {social_media_post}",
                    ...
                    return {"error": "AI response contained invalid JSON formatting."}
